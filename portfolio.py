...
portfolio_btc= _coinone.get_btc_balance()  +  _bithumb.get_btc_balance()# +_korbit.get_btc_balance() 
     
portfolio_cash = _coinone.get_krw_balance() + _bithumb.get_krw_balance()  #+ _korbit.get_krw_balance()  

portfolio = portfolio_btc * _coinone.get_current_price() + portfolio_cash
